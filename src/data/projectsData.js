export const projectsData = [
  ...
  },
  {
    ...
    status: 'Completado',
    category: 'Programación',
    shortDescription: 'Generador automático de informes médicos estructirados en el diagnóstico de cáncer de pulmón',
  ...
  },
  {
    ...
    status: 'Completado',
    category: 'IoT',
    shortDescription: 'Red inalámbrica de sensores para la detección precoz de incendios forestales',
  ...
  },
  {
    ...
    status: 'Completado',
    category: 'IoT',
    shortDescription: 'Comedero automático para mascotas conectado a smarthome y con alimentación ininterrumpida',
    coverImage: '/projects/forest-sensors.jpg',
  ...
  },
  {
    ...
    status: 'Completado',
    category: 'IoT',
    shortDescription: 'Dispositivo automático para el control de estores de ventana, integrado con Home Assistant y capaz de funcionar de forma autónoma.',
    coverImage: '/projects/contra-project.jpg',
  ...
  },
  {
    ...
    status: 'Completado',
    category: 'Automoción',
    shortDescription: 'Sustitución de la radio original de un Peugeot 207 por una pantalla Android Junsun v2 Plus',
  ...
  },
  {
    ...
    status: 'Completado',
    category: 'Automoción',
    shortDescription: 'Diseño y construcción de un panel de control de la iluminación de un Peugeot 207',
  ...
  },
  {
    ...
    status: 'Completado',
    category: 'Automoción',
    shortDescription: 'Instalación y control de puntos de luz LED en el marco de las puertas de un Peugeot 207',
    coverImage: '/projects/lighting-control.jpg',
    technologies: ['LED', 'Peugeot 207'],
    tags: ['electrónica', 'iluminación', 'automoción'],
